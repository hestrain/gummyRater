...
export async function getGummys() {
    ...
    const response = await axios.get(`${URL}/gummies`)
    if (response.status === 200) {
...
export async function getGummy(id) {
    const response = await axios.get(`${URL}/gummies/${id}`)
    if (response.status === 200) {
        return response.data
    } else {
        return
...
export async function createGummy(gummy) {
    const response = await axios.post(`${URL}/gummies`, gummy)
        return response
}
export async function updateGummy(id, gummy) {
    const response = await axios.put(`${URL}/gummies/${id}`, gummy)
        return response
}
export async function deleteGummy(id) {
    const response = await axios.delete(`${URL}/gummies/${id}`)
